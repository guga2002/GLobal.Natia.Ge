...
//        await redis.SetAsync("SystemStreamInfo", res);
...
//        await redis.SetAsync("letscheck", allMessages.Where(i => !i.Contains("არ შეიცავს ვიდეო ნაკადს")).ToList(), TimeSpan.FromMinutes(30));
//    }
