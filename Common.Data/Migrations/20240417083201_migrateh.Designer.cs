...
namespace Jandag.DLL.Migrations
{
    ...
    [Migration("20240417083201_migrateh")]
    partial class migrateh
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDL.Database_Layer.Entities.Chanell", b =>
                {
                    ...
                    b.Property<int?>("SatteliteFrequencyId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("SatteliteFrequencyId");
            ...
            modelBuilder.Entity("DDL.Database_Layer.Entities.Chanell", b =>
                {
                    b.HasOne("Jandag.DLL.Entities.SatteliteFrequency", null)
                        .WithMany("chanells")
                        .HasForeignKey("SatteliteFrequencyId");
                });
